@extends('news.news')
@section('news-list-active','active')
...
<div class="card-body">
    ...
    <div class="d-flex flex-row justify-content-between">
      ...
      <div class="d-flex flex-row align-items-center">
        ...
        <form action="{{ url('show_entries') }}" method="post" name="show-entries-form">
          ...
          @csrf
          <select class="form-select" aria-label="Default select example" id='news-limit' name='news-limit' onchange="javascript: submitEntries()">
        ...
        <table class="table table-striped table-valign-middle">
            <thead>
                <tr>
                    ...
                    <th>Image</th>
                    <th>@sortablelink('title', 'News Title  ')</th>
                    <th>HeadLine</th>
                    <th>Published</th>
            ...
            <tbody>
               ...
               @if (count($news) > 0)
                 ...
                 <tr class="align-middle">
                    <td>
                        <img  alt="60x60" width="60px" height="60px" src="{{ $n->url_image }}" data-holder-rendered="true">
                    </td>
                    <td>{{ $n->title }}</td>
                    ...
                    <td>
                        ...
                        <form method="POST" action="{{ url('news/'.$n->id) }}" accept-charset="UTF-8">
    ...
    <div class="d-flex flex-row justify-content-between">
        <div class="text-center m-2"><p>Showing {{ $news->count() }} of {{ $news->total() }} entries</p></div>
